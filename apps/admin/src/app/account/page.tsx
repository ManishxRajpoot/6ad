...
import { authApi, profileSettingsApi } from '@/lib/api'
import {
  Upload,
  Loader2,
  Shield,
...
function AccountSettingsContent() {
  ...
  const handleAvatarUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    if (file) {
      ...
      reader.onloadend = async () => {
        ...
        try {
          await profileSettingsApi.updateAvatar(base64)
  ...
  const handleSaveProfile = async () => {
    ...
    try {
      await profileSettingsApi.update({ realName: fullName })
      const { user: updatedUser } = await authApi.me()
      updateUser(updatedUser)
  ...
  const handleSaveContact = async () => {
    ...
    try {
      await profileSettingsApi.update({ phone: contact1, phone2: contact2 })
      const { user: updatedUser } = await authApi.me()
      updateUser(updatedUser)
  ...
  return (
    <DashboardLayout title="Account Settings" subtitle="Manage your admin account">
      {/* Success Toast - Centered Floating */}
      {toast && toast.type === 'success' && (
        <div className="fixed inset-0 z-[100] flex items-center justify-center pointer-events-none">
          <div className="flex flex-col items-center gap-3 px-8 py-6 rounded-2xl bg-white border-2 border-primary-500 shadow-2xl animate-[toastPop_0.4s_ease-out]">
            <div className="w-16 h-16 rounded-full bg-primary-500 flex items-center justify-center animate-[checkBounce_0.5s_ease-out_0.2s_both]">
              <Check className="w-8 h-8 text-white" strokeWidth={3} />
            </div>
            <span className="text-lg font-semibold text-primary-500">Success!</span>
      ...
      <div className="flex flex-col lg:flex-row gap-4 lg:gap-6 h-auto lg:h-[calc(100vh-140px)]">
        ...
        <div className="w-full lg:w-72 lg:flex-shrink-0">
          <Card className="p-4 h-full">
            {/* User Profile Card */}
            <div className="flex items-center gap-3 p-3 mb-4 bg-gradient-to-r from-primary-500/10 to-primary-100/50 rounded-xl">
              <div className="relative flex-shrink-0">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white text-lg font-bold overflow-hidden ring-2 ring-white shadow">
                  {avatar ? (
              ...
              <div className="min-w-0 flex-1">
                <p className="text-sm font-semibold text-gray-900 truncate">{(user as any)?.realName || user?.username || 'Admin'}</p>
                <p className="text-xs text-gray-500 truncate">{user?.email}</p>
                <span className="inline-block mt-1 px-2 py-0.5 bg-primary-500 text-white text-[10px] font-medium rounded-full">Admin</span>
              </div>
            </div>
              ...
              {menuItems.map((item) => (
                ...
                >
                  <div className={`w-9 h-9 rounded-lg flex items-center justify-center transition-colors ${
                    ...
                    <item.icon className={`w-5 h-5 ${activeTab === item.id ? 'text-white' : 'text-primary-500'}`} />
                  </div>
            ...
            <div className="mt-6 p-4 bg-primary-50 rounded-xl border border-primary-100">
              <p className="text-xs font-medium text-primary-600 uppercase tracking-wider mb-3">Security Status</p>
              ...
              <div className="space-y-8 max-w-2xl animate-tabFadeIn">
                  ...
                  <div className="flex items-center gap-5">
                    <div className="relative flex-shrink-0">
                      <div
                        ...
                        className="w-20 h-20 rounded-full bg-gradient-to-br from-primary-500 to-primary-600 flex items-center justify-center text-white text-2xl font-bold cursor-pointer hover:opacity-90 transition-opacity overflow-hidden ring-4 ring-gray-100 shadow-lg"
                      >
                        {avatar ? (
                          <img src={avatar} alt="Avatar" className="w-full h-full object-cover" />
                        ) : (
                      ...
                      <button
                        ...
                        className="absolute -bottom-1 -right-1 w-8 h-8 bg-primary-500 rounded-full flex items-center justify-center text-white shadow-lg hover:bg-primary-600 transition-colors disabled:opacity-50"
                      >
                ...
                <div className="pb-6 border-b border-gray-100">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 focus:bg-white transition-all"
                      />
                    </div>
                    <div>
                    ...
                    <div className="md:col-span-2">
                      ...
                      {!showEmailChange ? (
                        <div className="flex gap-2">
                          ...
                          {emailVerified && (
                            <button
                              ...
                              className="flex items-center gap-2 px-4 py-2.5 bg-primary-50 hover:bg-primary-100 text-primary-600 rounded-lg text-sm font-medium transition-all"
                            >
                        ...
                        <div className="space-y-3 p-4 bg-primary-50 border border-primary-100 rounded-xl">
                          <div className="flex items-center justify-between">
                          ...
                          {!emailChangeCodeSent ? (
                            <>
                              ...
                              <button
                                ...
                                className="flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                              >
                            ...
                            <>
                              <p className="text-sm text-gray-500">
                                Enter the 6-digit code sent to <span className="font-medium text-primary-600">{newEmail}</span>
                              </p>
                              <input
                                type="text"
                                ...
                                placeholder="000000"
                                maxLength={6}
                                className="w-full px-4 py-3 bg-white border border-gray-200 rounded-lg text-lg text-center tracking-[0.5em] font-mono focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 transition-all"
                              />
                              <div className="flex gap-3">
                                ...
                                <button
                                  ...
                                  className="flex-1 flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-4 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                  ...
                  <button
                    ...
                    className="mt-4 flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-6 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                  >
                    ...
                    <div>
                      ...
                      <div className="relative">
                        ...
                        <input
                          ...
                          className="w-full pl-10 pr-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 focus:bg-white transition-all"
                        />
                      </div>
                    </div>
                    <div>
              ...
              <div className="space-y-8 max-w-2xl animate-tabFadeIn">
                ...
                <div className="pb-6 border-b border-gray-100">
                  ...
                  <div className="space-y-4">
                    <div>
                      ...
                      <div className="relative">
                        <input
                          ...
                          className="w-full px-4 pr-12 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 focus:bg-white transition-all"
                        />
                        <button
                          type="button"
                    ...
                    <button
                      ...
                      className="flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-6 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                    >
                ...
                <div className="pb-6 border-b border-gray-100">
                  <div className="flex items-center justify-between mb-4">
                    ...
                    {emailVerified && (
                      <span className="px-2.5 py-1 bg-primary-500 text-white rounded-full text-xs font-medium flex items-center gap-1">
                  ...
                  {emailVerified ? (
                    ...
                    <div className="space-y-4">
                      <p className="text-sm text-gray-500">
                        Enter the 6-digit code sent to <span className="font-medium text-primary-600">{user?.email}</span>
                      </p>
                      <input
                        type="text"
                        value={emailCode}
                        ...
                        placeholder="000000"
                        maxLength={6}
                        className="w-full max-w-xs px-4 py-3 bg-gray-50 border border-gray-200 rounded-lg text-lg text-center tracking-[0.5em] font-mono focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 focus:bg-white transition-all"
                      />
                      <div className="flex gap-3">
                        <button
                        ...
                        <button
                          ...
                          className="flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50"
                        >
                        ...
                        <div className="flex-1 space-y-4">
                          ...
                          {secretKey && (
                            <div>
                              ...
                              <div className="flex items-center gap-2">
                                ...
                                >
                                  {copiedSecret ? <Check className="w-4 h-4 text-primary-600" /> : <Copy className="w-4 h-4" />}
                                </button>
                              </div>
                            </div>
                          )}
                          ...
                          <div>
                            ...
                            <input
                              ...
                              placeholder="000000"
                              maxLength={6}
                              className="w-full max-w-xs px-4 py-2.5 bg-gray-50 border border-gray-200 rounded-lg text-sm text-center tracking-[0.5em] font-mono focus:outline-none focus:ring-2 focus:ring-primary-500/20 focus:border-primary-500 focus:bg-white transition-all"
                            />
                          </div>
                          ...
                          <div className="flex gap-3">
                            ...
                            <button
                              ...
                              className="flex items-center justify-center gap-2 bg-primary-500 hover:bg-primary-600 text-white px-5 py-2.5 rounded-lg text-sm font-medium transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                            >
