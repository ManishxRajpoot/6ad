...
export function PaginationSelect({
  ...
  return (
    <div className={cn('relative', className)} ref={selectRef}>
      ...
      {isOpen && (
        <div className="absolute z-50 bottom-full mb-1 left-0 min-w-[70px] bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden animate-dropdownIn">
          <div className="py-1">
            {options.map((option) => (
              <button
                key={option.value}
