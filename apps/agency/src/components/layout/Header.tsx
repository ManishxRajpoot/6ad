      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            {/* Dropdown Menu */}
            <div
              className={`absolute right-0 top-full mt-2 w-64 bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden transition-all duration-300 ease-out origin-top-right ${
                showDropdown
            ...
            >
              ...
              <div className="border-t border-slate-100 py-1.5">
                <button
                  ...
                  className="w-full flex items-center gap-3 px-5 py-3 text-base text-slate-600 hover:bg-red-50 hover:text-red-600 transition-all duration-200 group"
                >
                  <div className="w-10 h-10 rounded-lg bg-slate-100 group-hover:bg-red-100 flex items-center justify-center transition-colors">
