          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <label className="flex items-center gap-2 cursor-pointer group">
              <div className="relative">
                ...
                />
                <div className="w-[15px] h-[15px] border-[1.5px] border-gray-300 rounded peer-checked:bg-teal-600 peer-checked:border-teal-600 transition-all flex items-center justify-center group-hover:border-teal-400">
                  {rememberMe && (
