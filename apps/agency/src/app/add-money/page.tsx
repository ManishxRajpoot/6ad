...
export default function AddMoneyPage() {
  ...
  const [walletFlowPerPage, setWalletFlowPerPage] = useState(25)
  ...
  return (
    <DashboardLayout title="Add Money" subtitle="Manage your wallet deposits and transactions">
      ...
      <Card className="p-0 rounded-2xl overflow-hidden shadow-sm border border-gray-100 animate-scaleIn flex flex-col" style={{ height: 'calc(100vh - 140px)' }}>
                        ...
                        {item.remarks ? (
                          <div className="relative group/remarks">
                            ...
                            <div className="absolute z-50 left-0 top-full mt-1 hidden group-hover/remarks:block">
                              <div className="bg-gray-900 text-white text-[11px] rounded-lg px-2.5 py-1.5 max-w-[250px] shadow-lg whitespace-normal">
                                {item.remarks}
        ...
        {/* Pagination for Add Money - inside scroll area */}
        {activeTab === 'add-money' && filteredDeposits.length > 0 && (
          <div className="px-4 py-3 border-t border-gray-100 flex items-center justify-between bg-white sticky bottom-0">
              ...
              <div className="flex items-center gap-1">
                ...
                <button
                  onClick={() => setCurrentPage(p => Math.min(Math.ceil(filteredDeposits.length / itemsPerPage), p + 1))}
            ...
            <table className="w-full">
              ...
              <tbody className="divide-y divide-gray-50">
                {loadingWalletFlow ? (
                  ...
                  return paginatedWalletFlows.map((flow, index) => (
                      <tr
                        key={flow.id}
                        className="table-row-animate hover:bg-gradient-to-r hover:from-gray-50/50 hover:to-transparent transition-all duration-300 group"
                        style={{ opacity: 0 }}
      ...
      >
        ...
        <div className="space-y-2.5">
          ...
          <div className="grid grid-cols-2 gap-0 bg-gray-100 rounded-lg p-0.5">
            <button
      ...
      {/* Distribute Money Modal - Compact */}
      <Modal
          ...
          <div className="space-y-2.5">
            ...
            <div className="p-2.5 bg-gradient-to-r from-[#0D9488] to-[#9333EA] rounded-lg text-white">
              <div className="flex items-center gap-2">
                ...
                <div>
                  <p className="text-white/80 text-[10px]">Your Available Balance</p>
                  <p className="text-lg font-bold">${Number(user?.walletBalance || 0).toFixed(2)}</p>
                </div>
              </div>
            </div>

            {/* User Selection with Search - Compact */}
            <div className="space-y-1">
                          ...
                          .map((userItem) => (
                            ...
                            >
                              ...
                              <div className="flex-1 min-w-0">
                                ...
                                <p className="text-[10px] text-gray-500 truncate">{userItem.email}</p>
                              </div>
            ...
            {/* Selected User Info Card - Compact */}
              ...
              return (
                <div className="bg-[#0D9488]/5 border border-[#0D9488]/20 rounded-lg p-2.5">
                  <div className="flex items-center gap-2">
                    ...
                    <div className="flex-1">
                      <p className="font-semibold text-xs text-gray-800">{selectedUser.username}</p>
          ...
          <div className="space-y-2.5">
            ...
            {distributeForm.userId && distributeForm.amount && (
              <div className="bg-gray-50 rounded-lg p-2.5 border border-gray-100">
                <h4 className="text-[10px] font-semibold text-gray-500 uppercase mb-2">Transfer Summary</h4>
            ...
            <div className="p-2 bg-amber-50 rounded-lg border border-amber-100">
              <p className="text-[10px] text-amber-700">
                <span className="font-semibold">Note:</span> This will deduct from your wallet and add to user's wallet immediately.
              </p>
            </div>
          </div>
        </div>
