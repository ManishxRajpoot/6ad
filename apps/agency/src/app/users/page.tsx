        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-3">
          ...
          <Card className="p-3 relative overflow-hidden min-h-[80px]">
            <div className="flex items-start justify-between relative z-10">
              <div>
                <span className="text-[11px] text-gray-500">Total Users</span>
          ...
          <Card className="p-3 relative overflow-hidden min-h-[80px]">
            <div className="flex items-start justify-between relative z-10">
              ...
              <span className="px-2 py-0.5 bg-[#52B788] text-white text-[10px] font-medium rounded">All Users</span>
            </div>
          ...
          <Card className="p-3 relative overflow-hidden min-h-[80px]">
            <div className="flex items-start justify-between relative z-10">
              <div>
                <span className="text-[11px] text-gray-500">Your Coupons</span>
                <p className="text-xl font-bold text-gray-800">{agentCoupons.toLocaleString()}</p>
              </div>
              <span className="px-2 py-0.5 bg-[#F59E0B] text-white text-[10px] font-medium rounded">Available</span>
            </div>
          ...
          <Card className="p-3 relative overflow-hidden min-h-[80px]">
            <div className="flex items-start justify-between relative z-10">
              <div>
                <span className="text-[11px] text-gray-500">Blocked Users</span>
                <p className="text-xl font-bold text-gray-800">{blockedUsers.toLocaleString()}</p>
              </div>
        ...
        <Card className="p-0 overflow-hidden flex flex-col" style={{ height: 'calc(100vh - 280px)' }}>
            ...
            <table className="w-full animate-tabFadeIn text-[11px] xl:text-[12px]">
              <thead className="sticky top-0 z-10">
                <tr className="bg-gray-50 shadow-[0_1px_3px_rgba(0,0,0,0.08)]">
                  <th className="text-left py-2.5 px-3 font-semibold text-gray-500 uppercase tracking-wide text-[10px] whitespace-nowrap bg-gray-50 w-[18%]">User</th>
                  <th className="text-left py-2.5 px-3 font-semibold text-gray-500 uppercase tracking-wide text-[10px] whitespace-nowrap bg-gray-50 w-[18%]">Credentials</th>
                  <th className="text-right py-2.5 px-3 font-semibold text-gray-500 uppercase tracking-wide text-[10px] whitespace-nowrap bg-gray-50 w-[10%]">Balance</th>
                      ...
                      <td className="py-2.5 px-3">
                        <div className="flex items-center gap-2">
                          ...
                          <div className="min-w-0">
                            <p className="font-semibold text-gray-900 truncate max-w-[120px] xl:max-w-[160px]">{user.realName || user.username}</p>
                            <p className="text-gray-500 text-[10px] truncate max-w-[120px] xl:max-w-[160px]">{user.email}</p>
                          </div>
                        </div>
                      </td>
                      ...
                      <td className="py-2.5 px-3">
                        <div className="space-y-1">
                          <div className="flex items-center gap-1">
                            <code className="font-medium text-gray-700 bg-gray-100 px-1.5 py-0.5 rounded text-[11px] truncate max-w-[100px] xl:max-w-[140px]">{user.username}</code>
                            <button onClick={() => copyToClipboard(user.username)} className="p-1 hover:bg-gray-100 rounded transition-colors flex-shrink-0">
                          ...
                          <div className="flex items-center gap-1">
                            ...
                            {showPasswordId === user.id && user.plaintextPassword && (
                              <button onClick={() => copyToClipboard(user.plaintextPassword!)} className="p-1 hover:bg-gray-100 rounded transition-colors flex-shrink-0">
                                <Copy className="w-3 h-3 text-gray-400" />
                              </button>
                            )}
                          </div>
          ...
          <div className="flex-shrink-0 flex items-center justify-between px-4 py-3 border-t border-gray-100 bg-white text-[12px]">
            <div className="flex items-center gap-2">
              ...
              <PaginationSelect
                value={itemsPerPage}
                onChange={(val) => { setItemsPerPage(val === -1 ? filteredUsers.length : val); setCurrentPage(1) }}
              />
        ...
        <form onSubmit={handleSubmit} className="space-y-3 max-h-[75vh] overflow-y-auto">
          ...
          <div className="space-y-2">
            <h3 className="text-xs font-semibold text-gray-900 flex items-center gap-1.5">
              ...
              Platform Rates
              <span className="text-[9px] font-normal text-gray-400 ml-1">(Min values shown in grey)</span>
            </h3>
            ...
            <div className="rounded-lg border border-gray-200 overflow-hidden text-[10px]">
              <div className="grid grid-cols-4 bg-gray-50 border-b border-gray-200">
                ...
                <div className="px-2 py-1.5 font-semibold text-gray-600 text-center">Unlimited ($)</div>
              </div>
          ...
          {/* Remarks */}
          <div>
            <label className="block text-[10px] font-medium text-gray-500 mb-1">Personal Remarks</label>
            <textarea
