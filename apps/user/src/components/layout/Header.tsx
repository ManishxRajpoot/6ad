      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2 lg:gap-3">
          ...
          <div className="relative" ref={dropdownRef}>
            ...
            >
              ...
              <div className="lg:hidden relative">
                {user?.profileImage ? (
                  ...
                  <div className="w-8 h-8 rounded-full bg-gradient-to-br from-[#52B788] to-emerald-600 flex items-center justify-center ring-2 ring-gray-100">
                    <span className="text-white font-bold text-xs">
                      {user?.username?.charAt(0).toUpperCase() || 'U'}
                    </span>
                  </div>
                )}
                <div className="absolute -bottom-0.5 -right-0.5 w-2.5 h-2.5 bg-[#52B788] rounded-full border-[1.5px] border-white" />
              </div>
              {/* Desktop: avatar + name + chevron */}
              <div className="hidden lg:flex items-center gap-2.5 pl-1 pr-2 py-1 rounded-xl hover:bg-[#52B788]/5 transition-all duration-300">
            ...
            {/* Dropdown Menu */}
            <div
              className={`absolute right-0 top-full mt-2 w-52 lg:w-56 bg-white rounded-xl shadow-lg border border-slate-100 overflow-hidden transition-all duration-300 ease-out origin-top-right z-50 ${
                showDropdown
            ...
            >
              {/* User Info */}
              <div className="px-3.5 py-2.5 border-b border-slate-100 bg-gradient-to-r from-[#52B788]/5 to-emerald-50/50">
              ...
              <div className="py-1">
                <Link
                  ...
                  className="flex items-center gap-2.5 px-3.5 py-2.5 text-sm text-slate-600 hover:bg-[#52B788]/5 hover:text-[#52B788] transition-all"
                >
              ...
              <div className="border-t border-slate-100 py-1">
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3.5 py-2.5 text-sm text-red-500 hover:bg-red-50 transition-all"
                >
