...
import { Shield, Mail, Check, Loader2, Copy, ArrowRight, Smartphone, KeyRound } from 'lucide-react'
  ...
  return (
    <div className="fixed inset-0 z-[9999] flex items-center justify-center p-4 bg-black/50 backdrop-blur-sm">
      ...
      <div className="w-full max-w-3xl max-h-[85vh] bg-white rounded-2xl shadow-2xl overflow-hidden">
        {/* Header */}
        <div className="bg-gradient-to-r from-[#52B788] to-[#40A578] px-6 py-5">
        ...
        <div className="px-6 py-4 border-b border-gray-100 bg-gray-50">
          <div className="flex items-center justify-center gap-4">
            ...
            <div className={`w-12 h-0.5 ${user?.emailVerified ? 'bg-[#52B788]' : 'bg-gray-200'}`} />
        ...
        <div className="p-6 overflow-y-auto" style={{ maxHeight: 'calc(85vh - 180px)' }}>
          ...
          {step === 'email' && (
            <div className="max-w-md mx-auto">
              <div className="text-center mb-6">
                <div className="w-16 h-16 rounded-full bg-[#52B788]/10 flex items-center justify-center mx-auto mb-4">
                  <Mail className="w-8 h-8 text-[#52B788]" />
                </div>
              ...
              {!emailCodeSent ? (
                <button
                  ...
                  className="w-full flex items-center justify-center gap-2 bg-[#52B788] hover:bg-[#40A578] text-white py-3 rounded-lg font-medium transition-all disabled:opacity-50"
                >
                  {sendingCode ? (
                    <>
                    ...
                    <div className="flex gap-2 justify-center">
                      {[0, 1, 2, 3, 4, 5].map((index) => (
                        <input
                          ...
                          className="w-12 h-12 text-center text-lg font-semibold bg-gray-50 border-2 border-gray-200 rounded-lg focus:outline-none focus:border-[#52B788] focus:bg-white transition-all"
                        />
                      ))}
                    </div>
                  </div>
          ...
          {step === '2fa-setup' && (
            <div className="max-w-md mx-auto">
              <div className="text-center mb-6">
                <div className="w-16 h-16 rounded-full bg-[#52B788]/10 flex items-center justify-center mx-auto mb-4">
                  <Smartphone className="w-8 h-8 text-[#52B788]" />
                </div>
                ...
                <div className="mb-5">
                  ...
                  <div className="flex items-center gap-2 p-2 bg-gray-50 rounded-lg">
                    ...
                    <button
                      ...
                      className="p-1.5 text-gray-500 hover:text-[#52B788] rounded transition-all"
                    >
