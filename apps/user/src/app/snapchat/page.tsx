    ...
    const fetchData = async () => {
      try {
        ...
        const [userRes, accountsRes, refundsRes, depositsRes] = await Promise.all([
          authApi.me(),
          accountsApi.getAll('SNAPCHAT'),
          transactionsApi.refunds.getAll('SNAPCHAT'),
          accountDepositsApi.getAll('SNAPCHAT')
        ])
              ...
              <div className="relative">
                <div className="w-12 h-12 rounded-full bg-gradient-to-br from-[#FFFC00] to-[#E6E300] flex items-center justify-center shadow-md shadow-yellow-500/20">
                  <svg viewBox="0 0 24 24" className="w-7 h-7" fill="white">
                    <path d="M12.206 1c.737 0 1.455.055 2.14.162a8.64 8.64 0 011.906.52 5.98 5.98 0 011.618.9c.474.38.87.82 1.187 1.316.317.496.558 1.048.722 1.656.164.608.247 1.266.247 1.974v.447c0 .312.027.607.08.884.054.278.137.53.25.755.112.226.256.418.43.576.175.158.38.273.614.345a1.81 1.81 0 00.614.108c.194 0 .38-.022.556-.065a2.7 2.7 0 00.505-.184l.234.65a2.9 2.9 0 01-.54.29 2.52 2.52 0 01-.755.173 2.38 2.38 0 01-.83-.054 2.2 2.2 0 01-.722-.324 1.95 1.95 0 01-.54-.54 1.79 1.79 0 01-.27-.722 13.8 13.8 0 01-.08-.884v-.447c0-.59-.064-1.13-.192-1.62a4.17 4.17 0 00-.573-1.316 3.73 3.73 0 00-.96-1.01 4.78 4.78 0 00-1.35-.677 7.4 7.4 0 00-1.62-.39A11.75 11.75 0 0012.206 2c-.59 0-1.168.045-1.736.135a7.4 7.4 0 00-1.62.39 4.78 4.78 0 00-1.35.677 3.73 3.73 0 00-.96 1.01 4.17 4.17 0 00-.573 1.316c-.128.49-.192 1.03-.192 1.62v.447c0 .312-.027.607-.08.884a1.79 1.79 0 01-.27.722 1.95 1.95 0 01-.54.54 2.2 2.2 0 01-.722.324 2.38 2.38 0 01-.83.054 2.52 2.52 0 01-.755-.173 2.9 2.9 0 01-.54-.29l.234-.65c.14.068.305.128.505.184.2.057.38.08.556.065a1.81 1.81 0 00.614-.108c.234-.072.44-.187.614-.345.175-.158.318-.35.43-.576.113-.226.196-.477.25-.755.054-.277.08-.572.08-.884v-.447c0-.708.083-1.366.247-1.974a5.08 5.08 0 01.722-1.656 4.5 4.5 0 011.187-1.316 5.98 5.98 0 011.618-.9 8.64 8.64 0 011.906-.52A13.3 13.3 0 0112.206 1z"/>
                  </svg>
                </div>
