...
export default function BingPage() {
  ...
  const statsData = useMemo(() => {
    ...
    return [
      { label: 'Pending Applications', numericValue: pendingApps, trend: appsGrowth.trend, badge: appsGrowth.badge, color: '#00809D', chartPath: generateChartPath(pendingApps, 'up') },
  ...
  const exportToExcel = (exportType: string) => {
    ...
    switch (exportType) {
      ...
      case 'refund':
      case 'refund-report':
        filename = exportType === 'refund' ? 'bing_refunds' : 'bing_refund_report'
    ...
    <DashboardLayout title="Bing User Management Account" subtitle="">
      ...
      <div className="flex items-center gap-2 mb-3 p-2 bg-white rounded-xl shadow-sm border border-gray-100/50">
              ...
              <div className="py-1">
                {exportOptions.map((option) => (
                  <button
                    ...
                    className="w-full px-4 py-2.5 text-sm text-left text-gray-700 hover:bg-[#00809D]/10 hover:text-[#00809D] transition-colors duration-150 flex items-center gap-2"
                  >
        ...
        <Button
          ...
          className="bg-gradient-to-r from-[#00809D] to-[#006B83] hover:from-[#006B83] hover:to-[#005A6F] text-white rounded-md shadow-sm whitespace-nowrap text-xs px-3 py-1.5 h-auto font-semibold"
        >
            ...
            <div className="flex items-end justify-between">
              ...
              <div className="w-24 h-12 relative">
                <svg viewBox="0 0 100 50" className="w-full h-full" preserveAspectRatio="none">
                  <defs>
                    <linearGradient id={`stat-gradient-bing-${index}`} x1="0%" y1="0%" x2="0%" y2="100%">
                  ...
                  <path
                    ...
                    fill={`url(#stat-gradient-bing-${index})`}
        ...
        <Card className="flex-1 p-0 rounded-2xl overflow-hidden border border-gray-100/50 shadow-sm flex flex-col min-h-0">
          ...
          <div className="overflow-y-auto flex-1 min-h-0 bg-gradient-to-b from-white to-gray-50/30">
              ...
              {(activeSubPage === 'transfer-balance' || activeSubPage === 'refund' || activeSubPage === 'refund-report') && (
                <div className="p-16 text-center">
                  <div className="w-16 h-16 mx-auto mb-4 rounded-2xl bg-gradient-to-br from-[#00809D]/20 to-[#52B788]/10 flex items-center justify-center text-[#00809D]">
                    <ComingSoonIcon />
                  </div>
