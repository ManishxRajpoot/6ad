              ...
              {menuItems.map((menu) => (
                <div key={menu.section}>
                  <button
                    ...
                    className="w-full flex items-center justify-between px-2 py-2 text-sm font-semibold text-gray-700 hover:bg-[#4285F4]/5 rounded-lg transition-all"
                  >
                    ...
                    {expandedSections.includes(menu.section) ? (
                      <ChevronUp className="w-4 h-4 text-[#4285F4]" />
                    ) : (
